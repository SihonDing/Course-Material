...
vcom -93 -work work {D:/FPGA_EXP/FPGA_EXP3_dxh/register0_7/register0_7_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  register0_7_tb
